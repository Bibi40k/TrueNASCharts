...
please report them to our [github](https://github.com/Bibi40k/TrueNASCharts/issues/new/choose). Bug reports that state something doesn't work without supporting items may be closed.
